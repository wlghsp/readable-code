package cleancode.minesweeper.asis.minesweeper.board.position;

import cleancode.minesweeper.asis.minesweeper.board.cell.Cell;
...
public class CellPositions {
    ...
    public List<CellPosition> subtract(List<CellPosition> positionListToSubtract) {
        ...
        CellPositions cellPositionsToSubtract = CellPositions.of(positionListToSubtract);
