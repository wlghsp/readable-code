...
public class MinesweeperGame {
    ...
    public static final String OPENED_CELL_SIGN = "■";// scanner
    ...
    private static void initializeGame() {
        ...
        for (int row = 0; row < BOARD_ROW_SIZE; row++) {
            for (int col = 0; col < BOARD_COL_SIZE; col++) {
                ...
                NEARBY_LAND_MINE_COUNTS[row][col] = countLandMines(row, col);
            }
        }
    }

    private static int countLandMines(int row, int col) {
        int count = 0;
